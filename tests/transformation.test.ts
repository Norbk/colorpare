import { fromCmyk, fromHsl, fromHsv, fromLab, fromRgb, fromXyz } from "../src";

describe("Tranform ", () => {
  describe("RGB {r: 45, g: 183, b: 67}", () => {
    const color = fromRgb({r: 45, g: 183, b: 67});
  ...
  describe("HSL {h: 166, s: 56, l: 23}", () => {
    const color = fromHsl({h: 166, s: 56, l: 23});
  ...
  describe("HSV {h: 129, s: 16, v: 83}", () => {
    const color = fromHsv({h: 129, s: 16, v: 83});
  ...
  describe("CMYK {c: 87, m: 10, y: 23, k: 2}", () => {
    const color = fromCmyk({c: 87, m: 10, y: 23, k: 2});
  ...
  describe("XYZ {x: 67, y: 16, z: 101}", () => {
    const color = fromXyz({x: 67, y: 16, z: 101});
  ...
  describe("CIELab {l: 33, a: -34, b: 81}", () => {
    const color = fromLab({l: 33, a: -34, b: 81});
